  ...
  return (
    <div className="p-6 h-full flex flex-col">
      ...
      <div className="flex-1 relative flex items-center justify-center min-h-[300px]">
        {/* Clock Marks (0, 6, 12, 18) */}
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="relative w-full h-full max-w-[260px] max-h-[260px]">
            <span className="absolute top-0 left-1/2 -translate-x-1/2 -mt-4 text-xs font-bold text-slate-400">00:00</span>
            <span className="absolute bottom-0 left-1/2 -translate-x-1/2 -mb-4 text-xs font-bold text-slate-400">12:00</span>
            <span className="absolute left-0 top-1/2 -translate-y-1/2 -ml-6 text-xs font-bold text-slate-400">18:00</span>
            <span className="absolute right-0 top-1/2 -translate-y-1/2 -mr-6 text-xs font-bold text-slate-400">06:00</span>
          </div>
        </div>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none text-slate-400">
          <p className="text-sm font-medium">Daily View</p>
        </div>
      </div>
    </div>
  );
